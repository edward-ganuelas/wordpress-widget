...
var _urls = __webpack_require__(332);
...
(function () {
    var app = new _vue2.default({
        ...
        methods: {
            getWordPressPosts: function getWordPressPosts(url) {
            ...
            onload: function onload(url) {
                ...
                var wordPressPromise = this.getWordPressPosts(url);
                wordPressPromise.then(function (success) {
                    // console.log(success)
                    _this.json = JSON.parse(success).posts[0];
                }, function (fail) {
                    console.log(fail);
                });
            }
    ...
    app.onload(_urls2.default.apiCall);
})();
...
var wordpressSiteUrl = 'edpau.wordpress.com'; //Put wordpress url here.
var apiCall = "https://public-api.wordpress.com/rest/v1.1/sites/" + wordpressSiteUrl + "/posts?per_page=1&orderby=date";
